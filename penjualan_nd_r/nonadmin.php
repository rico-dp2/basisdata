...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="menu">
            ...
            <a href="nonadmin.php"><i class="fa-solid fa-plus"></i><span>Tambah Penjualan</span></a>
            <a href="nonadmin.php"><i class="fa-sharp fa-solid fa-gear"></i><span>Atur Data</span></a>
            <a href="login.php" id="logout"><i class="fa-solid fa-right-from-bracket"></i><span>Logout</span></a>  
        </div> 
    </div>
